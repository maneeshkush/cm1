...
property[0] = "Superficie";
unit[0] = ["acro", "aro", "ettaro", "centimetro quadrato", "piede quadrato", "pollice quadrato", "chilometro quadrato", "metro quadrato", "miglio quadrato", "iarda quadrata", "piedi quadrati"];
...
defaultUnits[0] = ["acro", "miglio quadrato"];
...
property[2] = "Massa (Peso)";
unit[2] = ["tonnellata", "chilogrammo", "grammo", "milligrammo", "tonnellata [lunga, UK]", "tonnellata [corta, US]", "quintale [lungo, UK]", "quintale [corto, US]", "quarto [UK]", "quarto [US]", "slug", "stone", "libbra", "libbra troy", "oncia", "oncia troy", "Robie", "dracma", "dracma", "punto", "grano"];
...
defaultUnits[2] = ["chilogrammo", "libbra"];

property[3] = "Pressione";
unit[3] = ["atm", "bar", "mbar", "kgf/m2", "kgf/cm2", "kPa", "MPa", "Pa", "lbf/ft2", "psi", "torr", "ksi", "chilopascal [kPa]", "Pascal", "millimetro di mercurio [0 °C]", "atmosfera [standard]", "atmosfera tecnica [at]", "Colonna d'acqua [metro]", "chilogrammo-forza per metro quadrato", "dyne per centimetro quadrato", "grammo-forza per centimetro quadrato", "chilogrammo-forza per centimetro quadrato", "chilogrammo-forza per millimetro quadrato", "chilopond per metro quadrato", "millibar", "newton per metro quadrato", "oncia per pollice quadrato", "libbra per piede quadrato", "libbra per pollice quadrato", "poundal per piede quadrato", "atmosfera tecnica", "tonnellata per metro quadrato", "Colonna d'acqua [centimetro]", "Colonna d'acqua [pollice]", "Colonna d'acqua [millimetro]"];
...
defaultUnits[3] = ["libbra per pollice quadrato", "chilopascal [kPa]"];
...
property[5] = "Volume & Capacità";
unit[5] = ["metro cubo", "litro", "litro", "centilitro", "millilitro", "cc", "centimetro cubo", "microlitro", "tazza [metrica]", "cucchiaio da tavola [metrico]", "cucchiaino da tè [metrico]", "barile", "secchio", "barile [UK]", "secchio [UK]", "bozzolo [UK]", "piede cubo", "pollice cubo", "miglio cubo", "tazza", "dramma", "quinta", "gallone [liquido]", "gallone [UK]", "gill [US]", "gill [UK]", "minim", "oncia", "oncia [UK, liquido]", "quartuccio [UK]", "quartuccio [US]", "pinta", "pinta [UK]", "quarto", "Robie", "colpo", "cucchiaio da tavola", "cucchiaino da tè", "cucchiaio da tavola [UK]", "cucchiaino da tè [UK]"];
...
defaultUnits[5] = ["litro", "oncia"];

property[6] = "Accelerazione";
unit[6] = ["metro al secondo quadrato", "piede al secondo quadrato", "gravità (accelerazione)", "Galileo", "pollice al secondo quadrato"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["metro al secondo quadrato", "piede al secondo quadrato"];
...
property[8] = "Densità e Capacità di massa";
unit[8] = ["grammo per centimetro cubo", "grammo per litro", "grammo per millilitro", "chilogrammo per litro", "chilogrammo per metro cubo", "tonnellata per metro cubo", "milligrammo per litro", "milligrammo per millilitro", "oncia per pollice cubo", "oncia per gallone [UK]", "oncia per gallone [US]", "libbra per pollice cubo", "libbra per gallone [UK]", "libbra per gallone [US]"];
...
defaultUnits[8] = ["chilogrammo per metro cubo", "libbra per gallone [US]"];

property[9] = "Carica Elettrica";
unit[9] = ["Coulomb [C]", "Abcoulomb", "Ampereora [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampereora [A.hr]"];

property[10] = "Energia";
unit[10] = ["Btu", "Caloria (nutrizionale)", "Caloria (termochimica)", "Gallone (US) di GPL", "Cavallo-vapore ora", "Joule", "Chilogrammo-forza metro", "Chilowattora", "Ton (esplosiva)", "Wattora"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "Chilowattora"];

property[11] = "Forza";
unit[11] = ["Newton (N)", "Dina (dy)", "Chilogrammo-forza (kgf)", "Chilopond (kpf)", "Kip (k)", "Ounce force (ozf)", "Pound force (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Chilogrammo-forza (kgf)", "Newton (N)"];

property[12] = "Forza / Lunghezza";
unit[12] = ["Newton per metro (N/m)", "Pound force per inch (lbf/in)", "Pound force per foot (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton per metro (N/m)", "Pound force per inch (lbf/in)"];

property[13] = "Illuminazione";
...
property[14] = "Flusso Massico";
unit[14] = ["chilogrammo al secondo (kg/s)","libbra massa al secondo (lbm/s)","libbra massa al minuto (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["chilogrammo al secondo (kg/s)", "libbra massa al secondo (lbm/s)"];

property[15] = "Potenza";
unit[15] = ["Btu/ora","caloria/ora","gigawatt","cavallo vapore (elettrico)","cavallo vapore (internazionale)","cavallo vapore (metrico)","cavallo vapore (acqua)","chilocaloria/ora","kilowatt","megawatt","microwatt","milliwatt","tonnellata di refrigerazione","watt"];
...
defaultUnits[15] = ["cavallo vapore (elettrico)","watt"];

property[16] = "Coppia";
unit[16] = ["Newton-metro (N.m)","dyne-centimetro(dy.cm)","kgf-metro (kgf.m)","lbf-pollice (lbf.in)","lbf-piede (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metro (N.m)","kgf-metro (kgf.m)"];

property[17] = "Tempo";
unit[17] = ["Secondo (sec)", "Giorno (solare medio)", "Giorno (sidereo)", "Ora (solare medio)", "Ora (siderea1e)", "Minuto (solare medio)", "Minuto (sidereo)", "Mese (calendario medio)", "Secondo (sidereo)", "Anno (calendario)", "Anno (tropicale)", "Anno (sidereo)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Giorno (solare medio)","Secondo (sec)"];

property[18] = "Velocità";
unit[18] = ["chilometro al secondo","chilometro all'ora","centimetro al secondo","metro al secondo","metro al minuto","piede al secondo","piede al minuto","piede all'ora","miglio all'ora","miglio al secondo","miglio nautico all'ora","iard al secondo","nodo","mach","velocità della luce [aria]","velocità della luce [vuoto]","velocità del suono [aria]"];
...
defaultUnits[18] = ["chilometro all'ora","miglio all'ora"];

property[19] = "Viscosità";
unit[19] = ["Newton-secondo per metro","centipoise","centistoke","piede quadrato al secondo","Poise","poundal-secondo per piede quadrato","pound massa per piede al secondo","pound force-secondo per piede quadrato","rhe","slug per piede al secondo","stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-secondo per metro","poundal-secondo per piede quadrato"];

property[20] = "Portata volumetrica";
unit[20] = ["barile al minuto [UK]","barile al minuto [US]","centimetro cubo al secondo","piede cubo al secondo","metro cubo al secondo","millimetro cubo al secondo","gallone al secondo [UK]","gallone al secondo [US]","litro al secondo","millilitro al secondo"];
...
defaultUnits[20] = ["piede cubo al minuto","metro cubo al secondo"];

property[21] = "Angolo";
unit[21] = ["grado","grad","radiante","1/10 cerchio","1/16 cerchio","1/2 cerchio","1/4 cerchio","1/6 cerchio","1/8 cerchio","minuto d'arco","grado binario","radiante binario","ciclo","angolo completo","grado centesimale [grad]","mil","minuto d'arco milliarc","millisecondo d'arco","minuto","ottante","punto","quadrante","angolo retto","secondo","sestante","segno","angolo retto"];
...
defaultUnits[21] = ["radiante","grado"];
...
function clearResults() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>Per favore, scegli una grandezza fisica, due unità e inserisci un valore in una delle caselle qui sopra.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    if (q == 0) {
        return "";
    } // non è possibile calcolare il 'fattore'

    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat rimuove gli zeri alla destra.
    // 14 è la lunghezza del numero restituito dalla funzione PHP nel file xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // verifica se è un intero // invFact può essere zero se il 'fattore' è molto grande (> 10^12)

        ret += "<p><span class='destacado'>Formula:</span> dividi il valore in " + pluralForConverters(from, 2) + " per " + invFact + " perché 1 " + to + " è uguale a " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

        ret += "<p>Quindi, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" o <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

    } else {

        ret = "<p><span class='destacado'>Formula:</span> moltiplica il valore in " + pluralForConverters(from, 2) + " per il fattore di conversione '" + factorTxt + "'.</p>";

        ret += "<p>Quindi, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" o <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
    ...
    if (from == to) {
        return "Si prega di scegliere due unità diverse.";
    }

    var how = "<h3>Come convertire " + val + " " + from + " a " + to + "?<\/h3>";
    how += "<p>Per convertire da " + from + " a " + to + ", utilizzare la formula: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

    if (tuple == "Celsius_Fahrenheit") {
        //"Celsius Fahrenheit":q*9/5+32,
        how += "<p>Quindi, moltiplicando il valore '" + val + "' in " + from + " per 9, dividendo il risultato per 5 e aggiungendo 32, otteniamo:<\/p><p>";
        ...
        how += "<p>Quindi, aggiungendo 273.15 al valore '" + val + "' in " + from + ", otteniamo <\/p><p>";
        how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
    } else if (tuple == "Kelvin_Celsius") {
        //"Kelvin Celsius":q-273.15,
        how += "<p>Quindi, sottraendo 273.15 al valore '" + val + "' in " + from + ", otteniamo <\/p><p>";
        how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
    } else if (tuple == "Kelvin_Fahrenheit") {
        //"Kelvin Fahrenheit":q*9/5-459.67,
        how += "<p>Quindi, moltiplicando il valore '" + val + "' in " + from + " per 9, dividendo il risultato per 5 e sottraendo -459.67, otteniamo<\/p><p>";
        ...
        how += "<p>Quindi, sottraendo 32 al valore '" + val + "' in " + from + ", moltiplicando il risultato per 5 e dividendo il risultato per 9, otteniamo<\/p><p>";
        ...
        how += "<p>Quindi, aggiungendo 459.67 al valore '" + val + "' in " + from + ", moltiplicando il risultato per 5 e dividendo per 9, otteniamo<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " come frazione utilizzabile o un numero intero in " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Questi sono valori alternativi per " + qTxt + " " + pluralForConverters(from, q) + " in " + pluralForConverters(to) + ". Sono rappresentati come una frazione o un numero intero vicino al valore esatto (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> ecc.). L'errore di approssimazione, se presente, è a destra del valore.</p>";
