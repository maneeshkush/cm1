...
property[0] = "面積";
unit[0] = ["エーカー","アール","ヘクタール","平方センチメートル","平方フィート","平方インチ","平方キロメートル","平方メートル","平方マイル","平方ヤード","平方フィート"];
...
property[2] = "質量（重さ）";
unit[2] = ["トン","キログラム","グラム","ミリグラム","トン（英国長トン）","トン（米国短トン）","長トン（英国）","短トン（米国）","クォーター（英国）","クォーター（米国）","スラッグ","ストーン","ポンド","トロイポンド","オンス","トロイオンス","ロビー","ドラム","ドラクマ","ポイント","グレイン"];
...
defaultUnits[2] = ["キログラム", "ポンド"];

property[3] = "圧力";
unit[3] = ["atm","バール","mbar","kgf/m2","kgf/cm2","kPa","MPa","Pa","lbf/ft2","psi","torr","ksi","キロパスカル [kPa]","パスカル","水銀柱 [0 °C]","標準大気圧","技術大気圧","水柱 [メートル]","平方メートルあたりのキログラム力","平方センチメートルあたりのダイン","平方センチメートルあたりのグラム力","平方センチメートルあたりのキログラム力","平方ミリメートルあたりのキログラム力","平方メートルあたりのキログラムポンド","ミリバール","平方メートルあたりのニュートン","平方インチあたりのオンス","平方フィートあたりのポンド","平方インチあたりのポンダル","技術大気圧","平方メートルあたりのトン","水柱 [センチメートル]","水柱 [インチ]","水柱 [ミリメートル]"];
...
defaultUnits[3] = ["ポンドあたりの平方インチ", "キロパスカル [kPa]"];
...
property[5] = "容積と容量";
unit[5] = ["立方メートル", "リットル", "リットル", "センチリットル", "ミリリットル", "cc", "立方センチメートル", "マイクロリットル", "カップ [メトリック]", "大さじ [メトリック]", "小さじ [メトリック]", "バレル", "バケツ", "バレル [英国]", "バケツ [英国]", "ブッシェル [英国]", "立方フィート", "立方インチ", "立方マイル", "カップ", "ドラム", "フィフス", "ガロン [液体]", "ガロン [英国]", "ギル [米国]", "ギル [英国]", "ミニム", "オンス", "オンス [英国、液体]", "ペック [英国]", "ペック [米国]", "パイント", "パイント [英国]", "クォート", "ロビー", "ショット", "大さじ", "小さじ", "大さじ [英国]", "小さじ [英国]"];
...
defaultUnits[5] = ["リットル", "オンス"];

property[6] = "加速度";
unit[6] = ["平方メートル毎秒", "平方フィート毎秒", "重力（加速度）", "ガリレオ", "平方インチ毎秒"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["平方メートル毎秒", "平方フィート毎秒"];

property[7] = "キャパシタンス";
unit[7] = ["ファラデイ [F]", "ミリファラデイ [mF]", "マイクロファラデイ [µF]", "マノファラデイ [nF]", "ピコファラデイ [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["マイクロファラデイ [µF]", "ナノファラデイ [nF]"];

property[8] = "密度と質量容量";
unit[8] = ["立方センチメートル毎グラム", "リットル毎グラム", "ミリリットル毎グラム", "リットル毎キログラム", "立方メートル毎キログラム", "立方メートル毎トン", "リットル毎ミリグラム", "ミリリットル毎ミリグラム", "立方インチ毎オンス", "ガロン [英国]毎オンス", "ガロン [米国]毎オンス", "立方インチ毎ポンド", "ガロン [英国]毎ポンド", "ガロン [米国]毎ポンド"];
...
defaultUnits[8] = ["キログラム毎立方メートル", "ポンド毎ガロン [米国]"];

property[9] = "電気量";
unit[9] = ["クーロン [C]", "アブクーロン", "アンペア時 [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["クーロン [C]", "アンペア時 [A.hr]"];

property[10] = "エネルギー";
unit[10] = ["Btu","カロリー (栄養)","カロリー (熱量)","ガロン (US) LPG","馬力時","ジュール","キログラム力メートル","キロワット時","トン (爆発物)","ワット時"];
factor[10] = [1055.0559,4186.8,4.184,100757838.45,2684519.5,1,9.80665,3600000,4184000000,3600];
defaultUnits[10] = ["ジュール","キロワット時"];

property[11] = "力";
unit[11] = ["ニュートン (N)", "ダイン (dy)", "キログラム力 (kgf)", "キロポンド (kpf)", "キップ (k)", "オンス力 (ozf)", "ポンド力 (lbf)", "ポンダル"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["キログラム力 (kgf)","ニュートン (N)"];

property[12] = "力 / 長さ";
unit[12] = ["メートル毎ニュートン (N/m)","インチ毎ポンド力 (lbf/in)","フィート毎ポンド力 (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["メートル毎ニュートン (N/m)", "インチ毎ポンド力 (lbf/in)"];

property[13] = "照度";
unit[13] = ["ルーメン/平方メートル (lu/m²)", "ルーメン/平方センチメートル", "ルーメン/平方フィート", "フットキャンドル (ft-cdl)", "フットランバート", "カンデラ/平方メートル", "カンデラ/平方センチメートル", "ルクス (lx)", "ノックス (nx)", "フォト (ph)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["ルーメン/平方メートル (lu/m²)", "ルーメン/平方フィート"];

property[14] = "質量流量";
unit[14] = ["キログラム毎秒 (kg/s)", "ポンド質量毎秒 (lbm/s)", "ポンド質量毎分 (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["キログラム毎秒 (kg/s)", "ポンド質量毎秒 (lbm/s)"];

property[15] = "電力";
unit[15] = ["BTU/時間", "カロリー/時間", "ギガワット", "馬力 (電気)", "馬力 (国際)", "馬力 (メトリック)", "馬力 (水)", "キロカロリー/時間", "キロワット", "メガワット", "マイクロワット", "ミリワット", "冷凍トン", "ワット"];
...
defaultUnits[15] = ["馬力 (電気)", "ワット"];

property[16] = "トルク";
unit[16] = ["ニュートンメートル (N.m)", "ダインセンチメートル (dy.cm)", "キログラム力メートル (kgf.m)", "ポンド力インチ (lbf.in)", "ポンド力フィート (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["ニュートンメートル (N.m)", "キログラム力メートル (kgf.m)"];

property[17] = "時間";
unit[17] = ["秒（sec）", "日（平均太陽）", "日（恒星）", "時間（平均太陽）", "時間（恒星）", "分（平均太陽）", "分（恒星）", "月（平均暦）", "秒（恒星）", "年（暦年）", "年（黄道年）", "年（恒星）"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["日（平均太陽）", "秒（sec）"];

property[18] = "速度と速さ";
unit[18] = ["キロメートル毎秒", "キロメートル毎時", "センチメートル毎秒", "メートル毎秒", "メートル毎分", "フィート毎秒", "フィート毎分", "フィート毎時", "マイル毎時", "マイル毎秒", "海里毎時", "ヤード毎秒", "ノット", "マッハ", "光速度（空気中）", "光速度（真空中）", "音速度（空気中）"];
...
defaultUnits[18] = ["キロメートル毎時", "マイル毎時"];

property[19] = "粘度";
unit[19] = ["ニュートン秒毎メートル", "センチポアイズ", "センチストーク", "平方フィート毎秒", "ポアイズ", "ポンダル秒毎平方フィート", "ポンド質量毎フィート秒", "ポンド力秒毎平方フィート", "レオ", "スラッグ毎フィート秒", "ストーク"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["ニュートン秒毎メートル", "ポンダル秒毎平方フィート"];

property[20] = "体積流量";
unit[20] = ["分あたりバレル（英国）", "分あたりバレル（米国）", "立方センチメートル毎秒", "立方フィート毎秒", "立方メートル毎秒", "立方ミリメートル毎秒", "ガロン毎秒（英国）", "ガロン毎秒（米国）", "リットル毎秒", "ミリリットル毎秒"];
...
defaultUnits[20] = ["立方フィート毎分", "立方メートル毎秒"];

property[21] = "角度";
unit[21] = ["度", "グラード", "弧度", "1/10周", "1/16周", "1/2周", "1/4周", "1/6周", "1/8周", "分弧", "2進度", "2進弧度", "周期", "周角度", "グラディアン [グラード]", "ミル", "ミリ分弧", "弧秒", "分角度", "8分周", "ポイント", "4分周", "直角", "秒角度", "6分周", "サイン", "平角"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>物理量を選択し、2つの単位を選んで、上のボックスのいずれかに値を入力してください。</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if (q == 0) { return ""; } // 'factor'を計算できません
	var factor = parseFloat((converted / q).toPrecision(14)); // parseFloatは右側のゼロを削除します
	// 14はPHPファイルのxxxxx-unit-process.php内の関数によって返された数値の長さです
	var factorTxt = conversionFactorTxt(factor, 1E-8);
	var inv = 1 / factor;
	var invFact = roundDec(inv, 12);

	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // 整数かどうかを確認します // 'factor'が非常に大きい場合（> 10^12）invFactはゼロになります

		ret += "<p><span class='destacado'>式：</span> " + pluralForConverters(from, 2) + "内の値を" + invFact + "で割ります。なぜなら、1" + to + "は" + invFact + pluralForConverters(from, 2) + "に等しいからです。</p>";

		ret += "<p>したがって、" + qTxt + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? ("または<span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + "。</p>";

	} else {

		ret = "<p><span class='destacado'>式：</span> " + pluralForConverters(from, 2) + "内の値を変換係数'" + factorTxt + "'で乗算します。</p>";

		ret += "<p>したがって、" + qTxt + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? ("または<span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + "。</p>";
...
function explainTemperature(val, from, to) {
  ...
  if (from === to) {
    return "異なる単位を選択してください。";
  }

  var how = "<h3>" + val + " " + from + " から " + to + " への変換方法<\/h3>";
  how += "<p>" + from + " から " + to + " への変換には、次の式を使用します：<\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if (tuple === "Celsius_Fahrenheit") {
    how += "<p>したがって、" + from + " の値 '" + val + "' を 9 で掛け、その結果を 5 で割り、32 を加えると、<\/p><p>";
    how += val + " " + from + " = " + val + " × " + " 9⁄5 + 32 = " + roundDec(val * 9/5, dec) + " + 32 = " + roundDec(val * 9/5 + 32, dec) + " " + to + " になります。";
  } else if (tuple === "Celsius_Kelvin") {
    how += "<p>したがって、" + from + " の値 '" + val + "' に 273.15 を加えると、<\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + " になります。";
  } else if (tuple === "Kelvin_Celsius") {
    how += "<p>したがって、" + from + " の値 '" + val + "' から 273.15 を引くと、<\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + " になります。";
  } else if (tuple === "Kelvin_Fahrenheit") {
    how += "<p>したがって、" + from + " の値 '" + val + "' を 9 で掛け、その結果を 5 で割り、-459.67 を引くと、<\/p><p>";
    how += val + " " + from + " = " + val + " × " + " 9⁄5 - 459.67 = " + roundDec(val * 9/5, dec) + " - 459.67 = " + roundDec(val * 9/5 - 459.67, dec) + " " + to + " になります。";
  } else if (tuple === "Fahrenheit_Celsius") {
    how += "<p>したがって、" + from + " の値 '" + val + "' から 32 を引き、その結果を 5 で掛け、9 で割ると、<\/p><p>";
    how += val + " " + from + " = (" + val + " - 32) × 5⁄9 = (" + (val - 32) + ") × 5⁄9 = " + roundDec((val - 32) * 5/9, dec) + " " + to + " になります。";
  } else if (tuple === "Fahrenheit_Kelvin") {
    how += "<p>したがって、" + from + " の値 '" + val + "' に 459.67 を加え、その結果を 5 で掛け、9 で割ると、<\/p><p>";
    how += val + " " + from + " = (" + val + " + 459.67) × 5⁄9 = (" + (val + 459.67) + ") × 5⁄9 = " + roundDec((val + 459.67) * 5/9, dec) + " " + to + " になります。";
  }
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + "を使用可能な分数または整数に変換したもの (" + pluralForConverters(to, 2) + "):</h3>" + near + "<p class='compact'>これらは " + qTxt + " " + pluralForConverters(from, q) + "の代替値です。これらは分数または正確な値に近い整数として表されます（1/2、1/4、3/4 など）。近似誤差（あれば）は値の右に表示されます。</p>";
