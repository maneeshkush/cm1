function convert(){
	...
	with (document.converter){
		...
		var verb = "<h2>如何轉換</h2><p>將這些尺寸從英寸轉換為厘米，只需將每個值乘以2.54，因為1英寸 = 2.54厘米。所以，</p>";
	...
	var FAQ = "<div id='faqSection' itemtype='https://schema.org/FAQPage' itemscope=''>";
			...
			var FAQ = "<h2>關於英寸到厘米的長寬的常見問題</h2>";
			
			var q = "a的面積是多少 " + rectOrsquare + " measuring " + l.value + " &times; " + w.value + " 吋 等於 平方英吋 ?";
			...
			q = "a的面積是多少 " + rectOrsquare + " measuring " + l.value + " &times; " + w.value + " 吋換算成平方公分？";
			...
			a = "<p>" + l.value + " &times; " + w.value + " 英吋 = (" + l.value + " &times; 2.54) &times; (" + w.value + " &times; 2.54) = <span class='destacado'>" + lCm + " &times; " + wCm + "</span> 公分</p>";
			FAQ += FAQItem(q, a);
